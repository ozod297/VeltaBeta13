import TioktaImg from "./img/Tiokta.webp";
import Indutsit from "./img/Indutsit.webp";
import Trigamin from "./img/Trigamin.webp";
import Amantal from "./img/Amantal.webp";
import Asiron from "./img/Asiron.webp";
import Moksifilaks from "./img/Moksifilaks.webp";
import IndutsitRastvor from "./img/IndutsitRastvor.webp";
import kveniks from "./img/kveniks.webp";
import tirista from "./img/Tirista.webp";
import Salvita from "./img/Salvita.webp";
...
export const drugs = [
  {
    ...
    quantityUz: "50 mg",
    quantityRu: "50 мг",
    manufacturer: "O'bekiston respublikasi.",
    price: "77 000",
    tagColor: "tag-orange",
    bgColor: "#eff6ff",
    pillColor: "#F17E01",
    ...
    shape: "round",
    indicationsUz: [
      "Antioksidant, hujayralarni erkin radikallar shikastlashidan himoya qiladi.",
      "Hujayralarda energiya almashinuvini yaxshilaydi, asab tizimi faoliyatini qo'llab-quvvatlaydi.",
      "To'qimalarning qayta tiklanishi va regeneratsiyasini rag'batlantiradi.",
      "Yallig'lanish jarayonlarini kamaytiradi.",
      "Qondagi qand (shakar) miqdorini normal me'yorda ushlab turadi.",
      "Yuqori biologik o'zlashtirilishi (biomavjudligi) va organizm tomonidan yaxshi qabul qilinishi.",
    ],
    indicationsRu: [
      "Антиоксидант, защищает клетки от повреждения свободными радикалами.",
      "Улучшает энергетический обмен в клетках, поддерживает работу нервной системы.",
      "Стимулирует восстановление ирегенерацию тканей.",
      "Снижает воспалительные процессы.",
      "Поддерживает нормальный уровеньсахара в крови.",
      "Высокая биодоступность и хорошая переносимость.",
    ],
  ...
  },
  {
    ...
    quantityUz: "50 mg",
    quantityRu: "50 мг",
    manufacturer: "O'zbekiston respublikasi",
    price: "142 000",
    tagColor: "tag-red",
    bgColor: "#fffbeb",
    pillColor: "#A52C2E",
    ...
    dosageUz: [
      {
        holat:
          "O'tkir miokard infarktida, ishemiyada va shok holatlarini davolashda",
        doza: "100-200 ml",
        muddati: "2 kundan 7 kungacha",
      },
      {
        holat:
          "Ekstrakorporal qon aylanishi (EKQ) muolajasi amalga oshirilayotgan patsiyentlarga",
        doza: "100 ml",
        muddati: "5-7 kun",
      },
      {
    ...
    dosageRu: [
      {
        holat:
          "При остром инфаркте миокарда, ишемии и для лечения шоковых состояний",
        doza: "100-200 мл",
        muddati: "от 2 до 7 дней",
      },
      {
        holat:
          "Пациентам, проходящим процедуру экстракорпорального кровообращения (ЭКК)",
        doza: "100 мл",
        muddati: "5-7 дней",
      },
      {
      ...
      {
        holat:
          "При трансфузионной терапии (при многократных переливаниях крови)",
        doza: "50-100 мл",
        muddati: "3-5 дней",
      },
    ],
  ...
  },
  {
    ...
    shape: "oval",
    indicationsUz: [
      "Parkinson kasalligi (shu jumladan, akinetik krizlar, L-dopa sababli kelib chiqqan diskineziya)",
      "Turli etiologiyali parkinsonizm sindromi",
      "Bosh miyada qon aylanishining oʻtkir buzilishi (ishamik va gemorragik insultlar, subaraxnoidal qon quyilishi) natijasidagi hush va diqqat buzilishlari (ogʻirlashish, sopor, koma; tetiklik va normal reaksiyalar qobiliyatining pasayishi) hamda tashabbuskorlikning pasayishi (normal hush fonida atrof-muhitga qiziqishning kamayishi — toʻliq apatiyadan tortib psixosomatik noadekvat qoʻzgʻalishgacha)",
      "Diffuz serebral ishemiya (yurak-qon tomir yetishmovchiligida)",
      "Kalla-shon jarohati (bosh miya shikastlanishi)",
      "Kalla ichi siqilish jarayonlari (bosh miya oʻsmasi, bosh miyaga metastazlar, anevrizma)",
      "Endogen intoksikatsiyalar (diabet, uremiya, koma)",
      "Ekzogen intoksikatsiyalar (uyqu dori, alkogol, narkozdan keyingi psixotik sindrom)",
      "Nerv tizimining yuqumli kasalliklari (meningit, ensefalit va h.k.)",
      "Tranzitor sindromi",
      "Xantington xoreyasi",
      "Degenerativ demensiya, qon tomir demensiyasi",
      "Neyroleptik ekstrapiramidal sindromlar",
      "Herpes Zoster va gerpesdan keyingi nevralgiya",
      "Neyropatik ogʻriq",
  ...
  },
  {
    ...
    shape: "capsule",
    indicationsUz: [
      "O'tkir bakterial konyuktivitlar;",
    ...
    compositionUz: ["Moksiflokshatsin"],
    compositionRu: ["Моксифлоксацин"],
    contraindicationsUz: [
  ...
  {
    id: 7,
    slug: "Indutsit Rastvor",
    name: "Indutsit Rastvor",
    dose: "100 mg",
    category: "Rastvor",
    categoryUz: "Rastvor",
    categoryRu: "Раствор",
    ...
    compositionUz: ["Sitikolin, ", "Levokarnitin "],
    compositionRu: ["Цитиколин, ", "Левокарнитин "],
    contraindicationsUz: [
  ...
  },
  {
    ...
    dosageUz: [
      ...
      {
        holat:
          "Markaziy va periferik tomirlardagi og'ir qon aylanish yetishmovchiligida (НК), intoksikatsiya, gipoksiya, asteniya holatlarida",
    ...
    dosageRu: [
      ...
      {
        holat:
          "При тяжелых НК в центральных и периферических сосудах, интоксикации, гипоксии, астении",
  ...
  },
  {
    ...
    compositionUz: ["Rabeprazol natriy"],
    compositionRu: ["Рабепразол натрия"],
    contraindicationsUz: [
...
export const testimonials = [
  {
    id: 1,
    nameUz: "Otabek Karimov",
    nameRu: "Отабек Каримов",
    roleUz: "Apteka mutaxassisi",
    roleRu: "Специалист аптеки",
    avatar: "OK",
    bg: "#3b82f6",
    textUz:
      "Velta mahsulotlari sifati va narxi jihatidan eng maqbul tanlov. Mijozlarimiz doimo mamnun.",
    textRu:
      "Продукты Velta — оптимальный выбор по качеству и цене. Клиенты всегда довольны.",
  },
  {
    id: 2,
    nameUz: "Nilufar Yusupova",
    nameRu: "Нилуфар Юсупова",
    roleUz: "Klinika direktori",
    roleRu: "Директор клиники",
    avatar: "NY",
    bg: "#10b981",
    textUz:
      "Mijozlarimizga Velta dorilarini tavsiya etamiz. Sifati va ishonchlilik darajasi yuqori.",
    textRu: "Рекомендуем препараты Velta — высокое качество и надёжность.",
  },
  {
    id: 3,
    nameUz: "Sherzod Nasibov",
    nameRu: "Шерзод Абдуллаев",
    roleUz: "Umumiy amaliyot shifokori",
    roleRu: "Врач общей практики",
    avatar: "SA",
    bg: "#f59e0b",
    textUz:
      "Xalqaro standartlarda ishlab chiqarilgan Velta dorisi bemorlarimga muvaffaqiyatli qo'llaniladi.",
    textRu:
      "Препараты Velta по международным стандартам успешно применяю у пациентов.",
  },
];
...
export const certifications = [
  {
    id: 1,
    name: "GMP",
    fullUz: "Yaxshi Ishlab Chiqarish Amaliyoti",
    fullRu: "Надлежащая производственная практика",
    yearUz: "2021-yildan",
    yearRu: "С 2021 года",
  },
  {
    id: 2,
    name: "ISO 9001",
    fullUz: "Sifat menejment tizimi",
    fullRu: "Система менеджмента качества",
    yearUz: "2022-yildan",
    yearRu: "С 2022 года",
  },
  {
    id: 3,
    name: "ISO 13485",
    fullUz: "Tibbiy buyumlar sifati",
    fullRu: "Качество медицинских изделий",
    yearUz: "2024-yildan",
    yearRu: "С 2024 года",
  },
  {
    id: 4,
    name: "WHO‑PQ",
    fullUz: "JSST prekvlifikatsiyasi",
    fullRu: "Преквалификация ВОЗ",
    yearUz: "2026-yildan",
    yearRu: "С 2026 года",
  },
];
...
export const newsItems = [
  {
    id: 1,
    date: "2026-04-15",
    titleUz: "Velta yangi antibiotiklar seriyasini taqdim etdi",
    titleRu: "Velta представила новую серию антибиотиков",
    excerptUz:
      "Samarqanddagi zavodimizda ishlab chiqarilgan yangi keng spektrli antibiotiklar seriyasi rasman taqdim etildi.",
    excerptRu:
      "Новая серия антибиотиков широкого спектра действия официально представлена на рынке.",
    tag: "Yangilik",
    tagColor: "tag-blue",
  },
  {
    id: 2,
    date: "2026-03-20",
    titleUz: "ISO 13485 sertifikati yangilandi",
    titleRu: "Сертификат ISO 13485 обновлён",
    excerptUz:
      "Velta zavodi ISO 13485:2016 sertifikatini muvaffaqiyatli yangiladi.",
    excerptRu: "Завод Velta успешно подтвердил сертификат ISO 13485:2016.",
    tag: "Sertifikat",
    tagColor: "tag-green",
  },
  {
    id: 3,
    date: "2026-02-10",
    titleUz: "Pharmexpo 2026 ko'rgazmasida ishtirok",
    titleRu: "Участие в выставке Pharmexpo 2026",
    excerptUz:
      "Velta Toshkentda bo'lib o'tgan xalqaro farmatsevtika ko'rgazmasida ishtiroq etdi.",
    excerptRu:
      "Velta приняла участие в международной фармацевтической выставке в Ташкенте.",
    tag: "Tadbir",
    tagColor: "tag-amber",
  },
  {
    id: 4,
    date: "2026-01-05",
    titleUz: "Yangi Multivit Velta Complex taqdim etildi",
    titleRu: "Представлен новый Multivit Velta Complex",
    excerptUz:
      "12 ta vitamini va mineraldan iborat yangi kompleks mahsulot taqdim etildi.",
    excerptRu: "Представлен новый комплекс из 12 витаминов и минералов.",
    tag: "Mahsulot",
    tagColor: "tag-purple",
  },
];
